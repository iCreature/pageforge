"""
DocuForge Exception Classes

This module defines the exception hierarchy used throughout DocuForge.
...
class RenderingError(DocuForgeError):
...
class ResourceError(DocuForgeError):
...
class ConfigurationError(DocuForgeError):
