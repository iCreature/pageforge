...
# Import DocuForge components
from test_docuforge import (
...
class SimpleInvoiceLLM:
    ...
    def create_default_logo_if_needed(self):
        ...
        if not os.path.exists(self.default_logo_path):
            try:
                ...
                d.text((10, 10), "DocuForge", fill=(0, 0, 0), font=font)
    ...
    def generate_invoice_document(self, invoice_data: Dict[str, Any]) -> DocumentData:
        ...
        sections = [
            ...
            Section(type="footer", text="Page {page_number} of {total_pages} - Generated by DocuForge")
        ]
